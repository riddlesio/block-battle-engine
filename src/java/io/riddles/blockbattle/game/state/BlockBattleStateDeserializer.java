...
/**
 * BlockBattleStateDeserializer takes a serialised String and returns a BlockBattleState.
 *
 * @author jim
 */
public class BlockBattleStateDeserializer extends
        AbstractStateDeserializer<BlockBattlePlayer, BlockBattleState> {

    /* Constructor */
    public BlockBattleStateDeserializer(ArrayList<BlockBattlePlayer> players) {
        super(players);
    }

    @Override
    public BlockBattleState traverse(String statesString) throws JSONException {
        BlockBattleState state = null;
    ...
    private BlockBattleState visitState(JSONObject stateJson,
                                        BlockBattleState previousState) throws JSONException {
